...
for /L %%i in (1,1,8) do nircmd sendkeypress %_arrow.RIGHT%
nircmd sendkeypress %_ENTER%
nircmd sendkeypress %_WIN%+%_B%
for /L %%i in (1,1,4) do nircmd sendkeypress %_TAB%
for /L %%i in (1,1,10) do nircmd sendkeypress %_arrow.RIGHT%
nircmd sendkeypress %_ENTER%
nircmd wait 500
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
nircmd sendkeypress %_WIN%+%_B%
for /L %%i in (1,1,4) do nircmd sendkeypress %_TAB%
for /L %%i in (1,1,4) do nircmd sendkeypress %_arrow.RIGHT%
nircmd sendkeypress %_ENTER%
nircmd wait 1000
nircmd sendkeypress %_ENTER%
nircmd wait 1000
...
nircmd sendkeypress %_WIN%+%_B%
for /L %%i in (1,1,4) do nircmd sendkeypress %_TAB%
for /L %%i in (1,1,3) do nircmd sendkeypress %_arrow.RIGHT%
nircmd sendkeypress %_ENTER%
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
::start mspaint
::nircmd wait 5000
