...
echo HelloWorld
echo Программа предназначена для многократного добавления ячеек юпитера
echo Убедитесь что юпитер запущен
echo Убедитесь что курсор мыши выставлен на ячейку
echo Нажмите ё и наслаждайтесь
@echo off
...
echo %ERRORLEVEL%
nircmd sendkeypress %_HOME%
nircmd sendkeypress %_END%
nircmd sendkeypress %_SPACE%
nircmd sendkeypress %_DELETE%
nircmd sendkeypress %_HOME%
